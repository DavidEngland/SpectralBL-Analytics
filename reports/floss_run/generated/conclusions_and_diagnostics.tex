...
\begin{table}[htbp]
    ...
    \begin{tabular}{l p{9cm}}
        ...
        Manifold Complexity & Mean singular value entropy registers at $H_{\text{mean}} = 0.425$, yielding a Shannon effective dimension of $D_{\text{eff}} = 1.4920$. \\
        Numerical Stability & The condition number $\kappa = 55.88$ confirms a well-conditioned low-rank basis projection ($N_0 = 0$ nullspace modes). \\ \hline
    \end{tabular}
