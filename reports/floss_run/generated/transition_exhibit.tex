...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            title={Manifold Phase Portrait: FLOSS},
            extra x ticks=0.25,
...
\begin{itemize}
    \item Low-level Richardson proxy column: \texttt{ ri\_g\_0\_5 }
    \item Best lag correlation between $d\eta_3/dt$ and $d\mathrm{Ri}_g/dt$: $R_\tau=0.090$ at lag $\tau=-3600.00\,\mathrm{h}$ (-12 samples)
    \item Segmented mutual information (bits): $I(\eta_3;\mathrm{Ri}_g\leq \mathrm{Ri}_c)=1.901$, $I(\eta_3;\mathrm{Ri}_g>\mathrm{Ri}_c)=1.452$
\end{itemize}
