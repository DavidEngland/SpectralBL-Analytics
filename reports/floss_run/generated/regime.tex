...
\begin{itemize}
    ...
    \item \textbf{Temporal Coverage:} 11732.5 hours
    \item \textbf{Sample Count:} 70796 observations
\end{itemize}
...
\begin{figure}[htbp]
    \centering
    \tikzsetnextfilename{spectral-orthogonality-floss}
    \begin{tikzpicture}
        \begin{axis}[
            width=0.86\textwidth,
            ...
            xlabel={$\eta_1$},
            ylabel={$\eta_2$},
            title={Spectral Orthogonality Projection (FLOSS)},
            colormap/plasma,
            colorbar,
            point meta=explicit,
    ...
    \label{fig:spectral_orthogonality_floss}
\end{figure}
