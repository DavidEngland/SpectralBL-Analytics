...
This panel summarizes the continuation branch spectral abscissa $\alpha(\gamma)$ for campaign \texttt{ FLOSS }.


\begin{figure}[htbp]
    \centering
    \usepgfplotslibrary{groupplots}
    	tikzsetnextfilename{bifurcation-panel-floss}
    \begin{tikzpicture}
        \begin{groupplot}[
            group style={
        ...
        \nextgroupplot[
            ...
            \addplot[
                ...
                x=gamma,
                y=max_real_eig
            ] {../../data/outputs/stage5_bifurcation_branches_floss.csv};
    ...
    \label{fig:bifurcation_spectrum_floss}
\end{figure}
