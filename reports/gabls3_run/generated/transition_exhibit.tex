...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            title={Manifold Phase Portrait: GABLS3},
            extra x ticks=0.25,
...
\begin{itemize}
    \item Low-level Richardson proxy column: \texttt{ ri\_g\_10\_0 }
    \item Best lag correlation between $d\eta_3/dt$ and $d\mathrm{Ri}_g/dt$: $R_\tau=-0.366$ at lag $\tau=-12599.96\,\mathrm{h}$ (-21 samples)
    \item Segmented mutual information (bits): $I(\eta_3;\mathrm{Ri}_g\leq \mathrm{Ri}_c)=1.111$, $I(\eta_3;\mathrm{Ri}_g>\mathrm{Ri}_c)=n/a$
\end{itemize}
