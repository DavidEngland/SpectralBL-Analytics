...
\begin{figure}[htbp]
    ...
    \usepgfplotslibrary{groupplots}
    	tikzsetnextfilename{bifurcation-panel-gabls3}
    \begin{tikzpicture}
        \begin{groupplot}[
            group style={
...
This geometric framework complements local Richardson-number diagnostics by providing a globally consistent indicator of the boundary-layer stability state that remains valid through and beyond the classical collapse threshold of $\mathrm{Ri}_g = 0.25$.
