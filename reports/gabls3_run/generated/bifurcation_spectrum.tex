...
\noindent\textit{Stage 5 branch artifacts were not available for this campaign at report render time. Expected source: \path{../../data/outputs/stage5_bifurcation_branches_gabls3.csv}.}
