...
\subsection{ GABLS3 Precursor Diagnostics}

Campaign characteristics:
\begin{itemize}
    \item Duration: 23.8 hours (0.99 days)
    \item Samples: 144 profiles at 10.0-minute intervals
    \item State-space range: $\eta_3 \in [-0.07, 0.21]$
...
\begin{figure}[htbp]
    ...
    \caption{Multi-panel geometric precursor time series for GABLS3. 
