...
\begin{itemize}
    ...
    \item \textbf{Temporal Coverage:} 0.1 hours
    \item \textbf{Sample Count:} 2273 observations
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xlabel={$\eta_1$},
            ylabel={$\eta_2$},
            title={Spectral Orthogonality Projection (ARCTIC-AMPLIFICATION)},
            colormap/plasma,
            colorbar,
            point meta=explicit,
    ...
    \label{fig:spectral_orthogonality_arctic-amplification}
\end{figure}
...
\label{sec:regime_arctic-amplification}
