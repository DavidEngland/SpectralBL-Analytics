...
\begin{itemize}
    ...
    \item \textbf{Temporal Coverage:} 1463.5 hours
    \item \textbf{Sample Count:} 5600 observations
\end{itemize}
...
\begin{figure}[htbp]
    \centering
    \tikzsetnextfilename{spectral-orthogonality-bllast}
    \begin{tikzpicture}
        \begin{axis}[
            width=0.86\textwidth,
            ...
            xlabel={$\eta_1$},
            ylabel={$\eta_2$},
            title={Spectral Orthogonality Projection (BLLAST)},
            colormap/plasma,
            colorbar,
            point meta=explicit,
    ...
    \label{fig:spectral_orthogonality_bllast}
\end{figure}
