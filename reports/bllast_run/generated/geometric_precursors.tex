...
\subsection{ BLLAST Precursor Diagnostics}

Campaign characteristics:
\begin{itemize}
    \item Duration: 1463.5 hours (60.98 days)
    \item Samples: 5600 profiles at 15.7-minute intervals
    \item State-space range: $\eta_3 \in [-3.16, 2.45]$
    \item Mean trajectory speed: $\bar{v} = n/a$
\end{itemize}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{ precursor_diagnostic_bllast.png }
    \caption{Multi-panel geometric precursor time series for BLLAST. 
