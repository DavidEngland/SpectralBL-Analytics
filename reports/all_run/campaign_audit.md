...
Source data: ../../data/outputs/regime_scatterplots_all.csv
...
Source data: ../../data/outputs/regime_trajectories_all.csv
...
- **Trajectory source:** ../../data/outputs/regime_trajectories_all.csv
- **Scatter source:** ../../data/outputs/regime_scatterplots_all.csv
- **Stage 2 diagnostics:** ../../data/outputs/stage2_diagnostics_all.csv
- **Stage 4 lambda sweep:** ../../data/outputs/stage4_lambda_sweep.csv
- **Stage 5 branch CSV:** ../../data/outputs/stage5_bifurcation_branches_all.csv
