...
\begin{equation}
v(t) = \left\|\frac{d\vect{\eta}}{dt}\right\|,
\end{equation}
...
The authors thank the CASES-99, FLOSS, BLLAST, and GABLS3 teams for making their data publicly available. This work was supported by [funding sources].
\end{acknowledgments}
\FloatBarrier
\clearpage
\appendix
...
\caption{Kinematic evidence of critical slowing near fold approach using state-space speed $v(t)$ and inverse-time metric $\tau=1/v$.}
