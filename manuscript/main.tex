...
\begin{equation}
(z_0, C_v, Q_{net}, U_g) \rightarrow \text{surface coupling} \rightarrow \text{LLJ evolution} \rightarrow (\eta_2,\eta_3) \rightarrow \text{fold geometry} \rightarrow \text{regime transition},
\end{equation}
